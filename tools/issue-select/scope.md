...
I have used Python, TypeScript, JavaScript, C#, React, TailwindCSS, next.js, vitest, PostgreSQL, MATLAB, Docker, Redis, AWS, Ansible, Terraform, Github Actions, and FastAPI. I want to get better at Go, Rust, Ruby, C++, and Apache Kafka. Avoid Java, Angular, Kubernetes, R, and COBOL.
